...
The TriBITS framework has allowed Trilinos to scalably grow in the number of packages and the complexity without undo burdening of individual Trilinos developers and users.
