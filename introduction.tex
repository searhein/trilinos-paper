...
The organization of Trilinos into product areas and packages is illustrated in Figure~\ref{fig:GraphicalOverview}.
\begin{figure}
\centering
\input{graphical_overview.tex}
\caption{Organization of the Trilinos library into five product areas and their packages}
