...
\author{Sivasankaran Rajamanickam}\authornotemark[4]
...
\author{Roscoe A. Bartlett}\authornotemark[4]
\email{rabartl@sandia.gov}
\orcid{0000-0002-3831-8060}
\author{Luc Berger-Vergiat}\authornotemark[4]
\email{lberge@sandia.gov}
\orcid{0000-0001-5550-3527}
\author{Graham Harper}\authornotemark[4]
...
\author{Jonathan Hu}\authornotemark[4]
\email{jhu@sandia.gov}
\author{Drew P. Kouri}\authornotemark[4]
\email{dpkouri@sandia.gov}
\author{Paul Kuberry}\authornotemark[4]
\email{pakuber@sandia.gov}
\orcid{0000-0002-2426-4591}
\author{Kim Liegeois}\authornotemark[4]
\email{knliege@sandia.gov}
\orcid{0000-0002-1182-4078}
\author{Curtis C. Ober}\authornotemark[4]
\email{ccober@sandia.gov}
\author{Roger Pawlowski}\authornotemark[4]
\email{rppawlo@sandia.gov}
\author{Mauro Perego}\authornotemark[4]
\email{mperego@sandia.gov}
\author{Eric Phipps}\authornotemark[4]
\email{etphipp@sandia.gov}
\author{Denis Ridzal}\authornotemark[4]
\email{dridzal@sandia.gov}
\author{Nathan V. Roberts}\authornotemark[4]
\email{nvrober@sandia.gov}
\orcid{0000-0003-1536-0749}
\author{Christopher M. Siefert}\authornotemark[4]
\email{csiefer@sandia.gov}
\author{Heidi K. Thornquist}\authornotemark[4]
\email{hkthorn@sandia.gov}
\author{Romin Tomasetti}\authornotemark[4]
\email{romin.tomasetti@uliege.be}
\author{Christian R. Trott}\authornotemark[4]
\email{crtrott@sandia.gov}
\author{James M. Willenbring}\authornotemark[4]
\email{jmwille@sandia.gov}
\orcid{0000-0002-0418-9264}
\author{Michael M. Wolf}\authornotemark[4]
\email{mmwolf@sandia.gov}
\author{Ichitaro Yamazaki}\authornotemark[4]
...
\todo{Do we need Acknowledgments?}
