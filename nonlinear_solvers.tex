...
Sacado forward AD tools have been integrated into Kokkos and have demonstrated good performance on GPU architecture~\cite{phipps2022automatic}.
...
This approach allows to save computation time in four ways: the sample-independent data and computation can be reused for every samples of an ensemble, the memory access pattern is improved, 
