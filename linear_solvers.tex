...
Chebysev iteraton.  These are available both in point and block
...
like Vanka relaxation \cite{Vanka1986} can be supported.  Auxillary
...
implemented in Ifpack2 proper, Tpetra or called from Kokos kernels.
